...
class _ColorConfiguratorScreenState extends State<ColorConfiguratorScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushNamedAndRemoveUntil(context, AppRoute.messagesList, (route) => false);
        return false;
      },
      child: Scaffold(
        appBar: AppBar(
                            ...
                            content: SingleChildScrollView(
                              child: ColorPicker(
                                ...
                                onColorChanged: (color) {
                                  log(color.toString());
                                  ChatThemeCustom()
                                      .setBarContentColor(color: color);
                          ...
                          return AlertDialog(
                            ...
                            content: SingleChildScrollView(
                              child: ColorPicker(
                                ...
                                onColorChanged: (color) {
                                  log(color.toString());
                                  ChatThemeCustom().setFabColor(color: color);
                                },
                              ),
                            ),
                            actions: <Widget>[
